const groups = [
  ...
  },
  {
    location: 'Asia Pacific',
    country: 'India',
    name: 'Salesforce Marketer Group (Marketing Cloud), Jaipur, India',
    url: 'https://trailblazercommunitygroups.com/salesforce-marketer-group-marketing-cloud-jaipur-india/'
  },
  {
    location: 'Asia Pacific',
    country: 'India',
  ...
  },
  {
    location: 'North America',
    country: 'United States',
    name: 'Salesforce Marketer Group (Marketing Cloud), Philadelphia, United States',
    url: 'https://trailblazercommunitygroups.com/salesforce-marketer-group-marketing-cloud-philadelphia-united-states/'
  },
  {
    location: 'North America',
    country: 'United States',
